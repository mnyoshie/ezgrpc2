...
enum ezgrpc2_content_type {
  EZGRPC2_APPLICATION_GRPC = 1,
  EZGRPC2_APPLICATION_GRPC_PROTO = (1 << 1),
  EZGRPC2_APPLICATION_GRPC_JSON = (1 << 2),
};
typedef enum ezgrpc2_content_type ezgrpc2_content_type;
/* content type */
